...
import com.akash.flashbrowser.activity.BookmarkActivity
...
import com.akash.flashbrowser.adapter.BookmarkAdapter
import com.akash.flashbrowser.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onResume() {
        ...
        MainActivity.tabList[MainActivity.myPager.currentItem].name= "Home"
        ...
        binding.searchView.setOnQueryTextListener(object : SearchView.OnQueryTextListener {
            override fun onQueryTextSubmit(result: String?): Boolean {
                if(checkForInternet(requireContext()))
                    ...
                    Snackbar.make(binding.root, "Network Unavailable☹️", 3000).show()
                return true
            }
